  ...
  return (
    ...
    >
      ...
      <motion.div className="mb-8 text-center" variants={itemVariants}>
        ...
        <div className="mt-4 flex flex-col items-center max-w-xs mx-auto text-center">
          <p className="font-mono text-[10px] text-muted-foreground/80 uppercase tracking-widest leading-relaxed italic">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <div className="font-mono text-[9px] text-muted-foreground/40 uppercase tracking-[0.3em]">
