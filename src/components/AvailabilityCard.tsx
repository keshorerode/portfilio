    ...
    >
      ...
      <div className="mt-10">
        ...
        <p className="text-foreground text-sm">
          {data?.experience.internshipCompleted || "Experience in Full Stake Development."} <br />
          {data?.achievements[0] || "Passionate about building scalable solutions."} <br />
          {data?.experience.freelanceWork || "Open to freelance and contract work."}
        </p>
      </div>
      ...
      <div className="mt-10 flex justify-center">
        <button
          ...
          className="cursor-pointer rounded-full bg-foreground px-6 py-3 font-semibold text-background transition-colors duration-300 hover:bg-foreground/80"
        >
          Contact me
        </button>
      </div>
